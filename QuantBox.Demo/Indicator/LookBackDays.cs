...
{
    public class LookBackDays : SmartQuant.Indicator
    {
        // Fields
        ...
        // Methods
        public LookBackDays(ISeries input, int initialLength, int floorAmt, int ceilingAmt)
            : base(input)
        {
        ...
        {
            base.name = "LookBackDays";
            base.description = "Look Back Days";
            base.Clear();
            base.calculate = true;
        }
