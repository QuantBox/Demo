...
{
    public class DailyConsecutiveWinTrades : DailyStatisticsItem
    {
        ...
        public override string Name
        {
            get
            {
                return "Daily Consecutive Winning Trades";
            }
        }
        ...
        public override int Type
        {
            get
            {
                return PortfolioStatisticsType.DailyConsecutiveWinTrades;
            }
        }
    }
}
